...
def extract_details(input):
    ...
    model_id = "3a095fdb-a651-41fb-a0bb-49a0fece511a"
                ...
                for i in data["analyzeResult"]["documentResults"]:
                    if (i["docType"] == "custom:form"):
                        ...
                        if i["fields"]["gender"] is None:
                            ...
                            print("Gender : ", i["fields"]["gender"]["text"])
                            gen = i["fields"]["gender"]["text"]
                        ...
                        return org, cat, fn, mn, ln, d, ssn, email, tele, s,  c, st, gen, acc
